...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "S'està connectant a la xarxa de R-connect..."),
        ...
        ("install_tip", "En alguns casos és possible que el R-connect no funcioni correctament per les restriccions UAC («User Account Control»; Control de comptes d'usuari). Per evitar aquest problema, instal·leu el R-connect al vostre sistema."),
        ("Click to upgrade", "Feu clic per a actualitzar"),
        ("Configure", "Configura"),
        ("config_acc", "Per a poder controlar el dispositiu remotament, faciliteu al R-connect els permisos d'accessibilitat."),
        ("config_screen", "Per a poder controlar el dispositiu remotament, faciliteu al R-connect els permisos de gravació de pantalla."),
        ...
        ("android_input_permission_tip1", "Per a controlar de forma remota el vostre dispositiu amb gestos o un ratolí, heu de permetre al R-connect l'ús del servei «Accessibilitat»."),
        ("android_input_permission_tip2", "A l'apartat Configuració del sistema de la pàgina següent, aneu a «Serveis baixats», i activeu el «R-connect Input»."),
        ...
        ("Language", "Idioma"),
        ("Keep R-connect background service", "Manté el servei del R-connect en rerefons"),
        ("Ignore Battery Optimizations", "Ignora les optimitzacions de bateria"),
        ("android_open_battery_optimizations_tip", "Si voleu desactivar aquesta característica, feu-ho des de la pàgina següent de configuració del R-connect, utilitzant l'opció relativa a «Bateria»"),
        ...
        ("elevated_foreground_window_tip", "La finestra de connexió actual requereix permisos ampliats per a funcionar i, de forma temporal, no es pot utilitzar ni el teclat ni el ratolí. Demaneu a l'usuari remot que minimitzi la finestra actual, o bé que faci clic al botó Permisos ampliats de la finestra d'administració de la connexió. Per a evitar aquest problema en un futur, instal·leu el R-connect al dispositiu remot."),
        ...
        ("Show R-connect", "Mostra el R-connect"),
        ...
        ("config_input", "Per a poder controlar el dispositiu remotament amb el teclat, faciliteu al R-connect els permisos d'entrada necessaris."),
        ("config_microphone", "Per a poder parlar remotament, faciliteu al R-connect els permisos de gravació d'àudio necessaris."),
        ...
        ("still_click_uac_tip", "Es requereix acceptació manual a la part remota de la finestra «UAC» del R-connect en execució."),
        ...
        ("verify_rustdesk_password_tip", "Verifica la contrasenya del R-connect"),
        ...
        ("scam_text1", "Si cap persona qui NO coneixeu NI CONFIEU us demanés l'ús del R-connect, no continueu i talleu la comunicació immediatament."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Actualitzeu el R-connect Server Pro a la versió {} o superior!"),
        ...
        ("selinux_tip", "SELinux està activat al vostre dispositiu, la qual cosa evita que el R-connect funcioni correctament com a equip controlable."),
        ...
        ("powered_by_me", "Amb la tecnologia de R-connect"),
        ...
        ("allow-only-conn-window-open-tip", "Permet la connexió només si la finestra del R-connect està activa"),
        ...
        ("floating_window_tip", "Ajuda a mantenir el servei del R-connect en rerefons"),
        ...
        ("About R-connect", "Quant al R-connect"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Veuillez mettre à niveau le client R-connect vers la version {} ou plus récente du côté distant !"),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
