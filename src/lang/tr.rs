...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Kullanıcı Hesabı Denetimi nedeniyle, SISKOJAYA bir uzak masaüstü olarak düzgün çalışmayabilir. Bu sorunu önlemek için, SISKOJAYA'i sistem seviyesinde kurmak için aşağıdaki butona tıklayın."),
        ("Click to upgrade", "Yükseltmek için tıklayınız"),
        ("Configure", "Ayarla"),
        ("config_acc", "Masaüstünüzü dışarıdan kontrol etmek için SISKOJAYA'e \"Erişilebilirlik\""),
        ("config_screen", "Masaüstünüzü dışarıdan kontrol etmek için SISKOJAYA'e \"Ekran Kaydı\" iznini vermeniz gerekir."),
        ...
        ("android_input_permission_tip1", "Uzak bir cihazın Android cihazınızı fare veya dokunma yoluyla kontrol edebilmesi için, SISKOJAYA'in \"Erişilebilirlik\" özelliğini kullanmasına izin vermelisiniz."),
        ("android_input_permission_tip2", "Sonraki sistem ayarları sayfasına gidin, [Yüklü Hizmetler]'i bulun ve erişin, [SISKOJAYA Girişi] hizmetini etkinleştirin."),
        ...
        ("Language", "Dil"),
        ("Keep SISKOJAYA background service", "SISKOJAYA arka plan hizmetini sürdürün"),
        ...
        ("Show SISKOJAYA", "SISKOJAYA'i Göster"),
        ("This PC", "Bu PC"),
        ("or", "veya"),
        ...
        ("config_input", "Uzaktaki masaüstünü klavye ile kontrol etmek için SISKOJAYA'e \"Giriş İzleme\" izinleri vermelisiniz."),
        ("config_microphone", "Uzaktan konuşmak için SISKOJAYA'e \"Ses Kaydı\" izinleri vermelisiniz."),
        ...
        ("still_click_uac_tip", "Uzaktaki kullanıcının çalışan SISKOJAYA'in UAC penceresinde hala Tamam'ı tıklaması gerekmektedir."),
        ...
        ("verify_rustdesk_password_tip", "SISKOJAYA parolasını doğrulayın"),
