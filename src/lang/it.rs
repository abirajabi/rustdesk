...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connessione alla rete SISKOJAYA..."),
        ...
        ("install_tip", "A causa del Controllo Account Utente (UAC), SISKOJAYA potrebbe non funzionare correttamente come desktop remoto.\nPer evitare questo problema, fai clic sul tasto qui sotto per installare SISKOJAYA a livello di sistema."),
        ("Click to upgrade", "Aggiorna"),
        ("Configure", "Configura"),
        ("config_acc", "Per controllare il desktop dall'esterno, devi fornire a SISKOJAYA il permesso 'Accessibilità'."),
        ("config_screen", "Per controllare il desktop dall'esterno, devi fornire a SISKOJAYA il permesso 'Registrazione schermo'."),
        ...
        ("android_input_permission_tip1", "Affinché un dispositivo remoto possa controllare un dispositivo Android tramite mouse o tocco, devi consentire a SISKOJAYA di usare il servizio 'Accessibilità'."),
        ("android_input_permission_tip2", "Vai nella pagina delle impostazioni di sistema che si aprirà di seguito, trova e accedi a [Servizi installati], attiva il servizio [SISKOJAYA Input]."),
        ...
        ("Turned off", "Spegni"),
        ("Language", "Lingua"),
        ("Keep SISKOJAYA background service", "Mantieni il servizio di SISKOJAYA in background"),
        ("Ignore Battery Optimizations", "Ignora le ottimizzazioni della batteria"),
        ("android_open_battery_optimizations_tip", "Se vuoi disabilitare questa funzione, vai nelle impostazioni dell'applicazione SISKOJAYA, apri la sezione 'Batteria' e deseleziona 'Senza restrizioni'."),
        ...
        ("Show SISKOJAYA", "Visualizza SISKOJAYA"),
        ("This PC", "Questo PC"),
        ("or", "O"),
        ...
        ("config_input", "Per controllare il desktop remoto con la tastiera, è necessario concedere le autorizzazioni a SISKOJAYA 'Monitoraggio input'."),
        ("config_microphone", "Per poter chiamare, è necessario concedere l'autorizzazione 'Registra audio' a SISKOJAYA."),
        ...
        ("still_click_uac_tip", "Richiedi ancora che l'utente remoto selezioni 'OK' nella finestra UAC dell'esecuzione di SISKOJAYA."),
        ...
        ("verify_rustdesk_password_tip", "Conferma password SISKOJAYA"),
        ...
        ("scam_text1", "Se sei al telefono con qualcuno che NON conosci NON DI TUA FIDUCIA che ti ha chiesto di usare SISKOJAYA e di avviare il servizio, non procedere e riattacca subito."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Aggiorna SISKOJAYA Server Pro alla versione {} o successiva!"),
        ...
        ("selinux_tip", "In questo dispositivo è abilitato SELinux, che potrebbe impedire il corretto funzionamento di SISKOJAYA come lato controllato."),
        ...
        ("powered_by_me", "Alimentato da SISKOJAYA"),
        ...
        ("allow-only-conn-window-open-tip", "Consenti connessione solo se la finestra SISKOJAYA è aperta"),
        ...
        ("About SISKOJAYA", "Info su SISKOJAYA"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Aggiorna il client SISKOJAYA remoto alla versione {} o successiva!"),
