...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "لطفا برنامه را نصب کنید UAC و جلوگیری از خطای SISKOJAYA برای راحتی در استفاده از نرم افزار"),
        ("Click to upgrade", "برای ارتقا کلیک کنید"),
        ("Configure", "تنظیم"),
        ("config_acc", "بدهید \"access\" مجوز SISKOJAYA برای کنترل از راه دور دسکتاپ باید به"),
        ("config_screen", "بدهید \"screenshot\" مجوز SISKOJAYA برای کنترل از راه دور دسکتاپ باید به"),
        ...
        ("android_input_permission_tip1", "استفاده کند \"Accessibility\" اجازه دهید از ویژگی SISKOJAYA شما را از طریق ماوس یا صفحه ی لمسی کنترل کند، باید به Android برای اینکه یک دستگاه از راه دور بتواند دستگاه"),
        ("android_input_permission_tip2", "را پیدا کنید و فعال نمایید \"SISKOJAYA Input\" بشوید ، سپس گزینه \"Installed Services\" وارد قسمت \"Accessibility\" در صفحه تنظیمات "),
        ...
        ("Turned off", "خاموش شد"),
        ("Language", "زبان"),
        ("Keep SISKOJAYA background service", "را در پس زمینه نگه دارید SISKOJAYA سرویس"),
        ...
        ("Show SISKOJAYA", "SISKOJAYA نمایش"),
        ("This PC", "This PC"),
        ("or", "یا"),
        ...
        ("config_input", "برای کنترل دسکتاپ از راه دور با صفحه کلید، باید مجوز SISKOJAYA \"Input Monitoring\" را بدهید."),
        ("config_microphone", "را بدهید. SISKOJAYA \"Record Audio\" برای صحبت از راه دور، باید مجوز"),
        ...
        ("still_click_uac_tip", "همچنان کاربر از راه دور نیاز دارد که روی OK در پنجره UAC اجرای SISKOJAYA کلیک کند."),
        ...
        ("verify_rustdesk_password_tip", "رمز عبور SISKOJAYA را تأیید کنید"),
        ...
        ("scam_text1", "استفاده کنید و سرویس را راه‌اندازی کنید، صحبت می‌کنید، ادامه ندهید و بلافاصله تلفن را قطع کنید SISKOJAYA اگر با شخصی که نمی‌شناسید و به او اعتماد ندارید و از شما خواسته است از"),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "را به نسخه {} یا جدیدتر ارتقا دهید SISKOJAYA Server Pro لظفا"),
        ...
        ("selinux_tip", "به عنوان کنترل شده جلوگیری کند SISKOJAYA روی دستگاه شما فعال است ، که ممکن است از اجرای صحیح SELinux"),
        ...
        ("allow-only-conn-window-open-tip", "باز است اتصال برقرار شود SISKOJAYA زمانی که"),
        ...
        ("floating_window_tip", "کمک می کند SISKOJAYA این به حفظ سرویس پس زمینه"),
        ...
        ("About SISKOJAYA", "SISKOJAYA درباره"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "لطفاً SISKOJAYA را به نسخه {} یا جدیدتر در سمت راه دور ارتقا دهید"),
