...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Падключэнне да сеткі SISKOJAYA..."),
        ...
        ("install_tip", "У некаторых выпадках SISKOJAYA можа працаваць няправільна на аддаленым вузле з-за UAC. Каб пазбегнуць магчымых праблем з UAC, націсніце кнопку ніжэй для ўстаноўкі SISKOJAYA у сістэме."),
        ("Click to upgrade", "Абнавіць"),
        ("Configure", "Наладзіць"),
        ("config_acc", "Каб аддаленна кіраваць сваім працоўным сталом, вам неабходна дазволіць SISKOJAYA правы доступу."),
        ("config_screen", "Для аддаленага доступу да працоўнага сталу вам неабходна дазволіць SISKOJAYA правы здымку экрана."),
        ...
        ("android_input_permission_tip1", "Каб аддалёная прылада магла кіраваць вашай Android-прыладай з дапамогай мышы або націсканняў, неабходна дазволіць SISKOJAYA выкарыстоўваць паслугу \"Асаблівыя магчымасці\"."),
        ("android_input_permission_tip2", "Зайдзіце на адпаведную старонку сістэмных налад, знайдзіце і ўступіце ў \"Устаноўленыя паслугі\", уключыце паслугу \"SISKOJAYA Input\"."),
        ...
        ("Language", "Мова"),
        ("Keep SISKOJAYA background service", "Захаваць фонавую службу SISKOJAYA"),
        ...
        ("Show SISKOJAYA", "Паказаць SISKOJAYA"),
        ...
        ("config_input", "Каб кіраваць аддаленым працоўным сталом праз клавіятуру, неабходна дазволіць SISKOJAYA маніторынг уводу."),
        ("config_microphone", "Каб размаўляць з аддаленай старонкай, неабходна дазволіць SISKOJAYA запіс аўдыё."),
        ...
        ("still_click_uac_tip", "Дагэтуль патрэбна, каб аддалены карыстальнік націснуў \"OK\" ў акне UAC пры запуску SISKOJAYA."),
        ...
        ("verify_rustdesk_password_tip", "Пацвердзіць пароль SISKOJAYA"),
        ...
        ("scam_text1", "Калі вы размаўляеце па тэлефоне з кімсці, каго вы НЕ ВЕДАЕЦЕ і каму НЕ ДАВЕРАЕЦЕ, і ён просіць вас выкарыстаць SISKOJAYA і запусціць яго службу, не працягвайце і неадкладна адмяніце размову."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Абнавіце SISKOJAYA Server Pro да версіі {} або новейшай!"),
        ...
        ("selinux_tip", "На вашай прыладзе ўключаны SELinux, што можа перашкаджаць правільнай працы SISKOJAYA на кіруючым баку."),
        ...
        ("powered_by_me", "На аснове SISKOJAYA"),
        ...
        ("allow-only-conn-window-open-tip", "Дазволіць толькі падключэнне пры адкрытым акне SISKOJAYA"),
        ...
        ("floating_window_tip", "Дапамагае падтрымліваць фонавую службу SISKOJAYA"),
        ...
        ("new-version-of-{}-tip", ""),
        ("Accessible devices", ""),
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Калі ласка, абнавіце кліент SISKOJAYA да версіі {} або навейшай на аддаленым баку!"),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
