...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connecting to the R-connect network..."),
        ...
        ("install_tip", "Due to UAC, R-connect can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install R-connect to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant R-connect \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant R-connect \"Screen Recording\" permissions."),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow R-connect to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [R-connect Input] service."),
        ...
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next R-connect application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant R-connect \"Input Monitoring\" permissions."),
        ("config_microphone", "In order to speak remotely, you need to grant R-connect \"Record Audio\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running R-connect."),
        ...
        ("verify_rustdesk_password_tip", "Verify R-connect password"),
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use R-connect and start the service, do not proceed and hang up immediately."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Please upgrade R-connect Server Pro to version {} or newer!"),
        ...
        ("selinux_tip", "SELinux is enabled on your device, which may prevent R-connect from running properly as controlled side."),
        ...
        ("powered_by_me", "Powered by R-connect"),
        ...
        ("allow-only-conn-window-open-tip", "Only allow connection if R-connect window is open"),
        ...
        ("floating_window_tip", "It helps to keep R-connect background service"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Please upgrade the R-connect client to version {} or newer on the remote side!"),
