...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Notiek savienojuma izveide ar SISKOJAYA tīklu..."),
        ...
        ("install_tip", "UAC dēļ SISKOJAYA dažos gadījumos nevar pareizi darboties kā attālā puse. Lai izvairītos no UAC, lūdzu, noklikšķiniet uz tālāk esošās pogas, lai instalētu SISKOJAYA sistēmā."),
        ("Click to upgrade", "Jaunināt"),
        ("Configure", "Konfigurēt"),
        ("config_acc", "Lai attālināti vadītu savu darbvirsmu, jums ir jāpiešķir SISKOJAYA \"Pieejamība\" atļaujas."),
        ("config_screen", "Lai attālināti piekļūtu darbvirsmai, jums ir jāpiešķir SISKOJAYA \"Ekrāna tveršana\" atļaujas."),
        ...
        ("android_input_permission_tip1", "Lai attālā ierīce varētu vadīt jūsu Android ierīci, izmantojot peli vai pieskārienu, jums ir jāatļauj SISKOJAYA izmantot servisu \"Pieejamība\"."),
        ("android_input_permission_tip2", "Lūdzu, dodieties uz nākamo sistēmas iestatījumu lapu, atrodiet un atveriet [Instalētie pakalpojumi], ieslēdziet servisu [SISKOJAYA Input]."),
        ...
        ("Turned off", "Izslēgts"),
        ("Language", "Valoda"),
        ("Keep SISKOJAYA background service", "Saglabāt SISKOJAYA fona servisu"),
        ("Ignore Battery Optimizations", "Ignorēt akumulatora optimizāciju"),
        ("android_open_battery_optimizations_tip", "Ja vēlaties atspējot šo funkciju, lūdzu, dodieties uz nākamo SISKOJAYA lietojumprogrammas iestatījumu lapu, atrodiet un atveriet [Akumulators], noņemiet atzīmi no [Neierobežots]"),
        ...
        ("Show SISKOJAYA", "Rādīt SISKOJAYA"),
        ("This PC", "Šis dators"),
        ("or", "vai"),
        ...
        ("config_input", "Lai vadītu attālo darbvirsmu ar tastatūru, jums ir jāpiešķir SISKOJAYA \"Ievades uzraudzība\" atļaujas."),
        ("config_microphone", "Lai runātu attālināti, jums ir jāpiešķir SISKOJAYA \"Ierakstīt audio\" atļaujas."),
        ...
        ("still_click_uac_tip", "Joprojām attālajam lietotājam ir jānoklikšķina uz Labi UAC logā, kurā darbojas SISKOJAYA."),
        ...
        ("verify_rustdesk_password_tip", "Pārbaudīt SISKOJAYA paroli"),
        ...
        ("scam_text1", "Ja sarunājaties ar kādu, kuru nepazīstat un kurš ir lūdzis izmantot SISKOJAYA, lai sāktu pakalpojumu, neturpiniet un nekavējoties nolieciet klausuli."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Lūdzu, jauniniet SISKOJAYA Server Pro uz versiju {} vai jaunāku!"),
        ...
        ("selinux_tip", "Jūsu ierīcē ir iespējots SELinux, kas var neļaut SISKOJAYA pareizi darboties kā kontrolētajai pusei."),
        ...
        ("powered_by_me", "Darbojas ar SISKOJAYA"),
        ...
        ("allow-only-conn-window-open-tip", "Atļaut savienojumu tikai tad, ja ir atvērts SISKOJAYA logs"),
        ...
        ("floating_window_tip", "Tas palīdz uzturēt SISKOJAYA fona servisu"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Lūdzu, jauniniet attālās puses SISKOJAYA klientu uz versiju {} vai jaunāku!"),
