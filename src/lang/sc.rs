...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connessione a sa rete R-connect..."),
        ...
        ("install_tip", "Pro neghe de su Controllu Contu Utente (UAC), R-connect diat pòdere non funtzionare comente si tocat comente iscrivania remota.\nPro evitare custu problema, incarca in su butone inoghe in suta pro installare R-connect a livellu de sistema."),
        ("Click to upgrade", "Atualiza"),
        ("Configure", "Cunfigura"),
        ("config_acc", "Pro controllare s'iscrivania dae foras, depes frunire a R-connect su permissu 'Atzessibilidade'."),
        ("config_screen", "Pro controllare s'iscrivania dae foras, depes frunire a R-connect su permissu 'Registratzione ischermu'."),
        ...
        ("android_input_permission_tip1", "Pro chi unu dispositivu remotu potzat controllare unu dispositivu Android pro mèdiu de unu ratu o cun su tocu, depes cunsentire a R-connect de impreare su servìtziu 'Atzessibilidade'."),
        ("android_input_permission_tip2", "Bae a sa pàgina de sas impostatziones de sistema chi s'at a abèrrere a pustis, busca e intra a [Servìtzios installados], allughe su servìtziu [Intrada R-connect]."),
        ...
        ("Turned off", "Istuda"),
        ("Language", "Limba"),
        ("Keep R-connect background service", "Mantene su servìtziu de R-connect in s'isfundu"),
        ("Ignore Battery Optimizations", "Ignora sas otimizatziones de sa bateria"),
        ("android_open_battery_optimizations_tip", "Si boles disabilitare custa funtzione, bae a sas impostatziones de s'aplicatzione R-connect, aberi sa setzione 'Bateria' e boga sa seletzione a 'Chene restritziones'."),
        ...
        ("Show R-connect", "Mustra R-connect"),
        ("This PC", "Custu PC"),
        ("or", "O"),
        ...
        ("config_input", "Pro controllare s'elaboradore remotu cun su tecladu bisòngiat a frunire a R-connect sos permissos de 'Monitoràgiu insertada'."),
        ("config_microphone", "Per pòdere mutire, bisòngiat a frunire su premissu 'Registra àudio' a R-connect."),
        ...
        ("still_click_uac_tip", "Torra a pedire chi s'utente remotu seletziones 'AB' in sa ventana UAC de s'esecutzione de R-connect."),
        ...
        ("verify_rustdesk_password_tip", "Cunfirma sa crae de R-connect"),
        ...
        ("Exit", "Essi dae R-connect"),
        ("Open", "Aberi R-connect"),
        ...
        ("scam_text1", "Si ses in su telèfonu cun calicunu chi NON connosches NON FIDADU chi t'at pedidu de impreare R-connect e de allùghere su servìtziu, non sigas e tanca deretu."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Atualiza R-connect Server Pro a sa versione {} o prus noa!"),
        ...
        ("selinux_tip", "In custu dispositivu est abilitadu SELinux, chi diat pòdere su funtzionamentu curretu de R-connect comente ala controllada."),
        ...
        ("powered_by_me", "Alimentadu dae R-connect"),
        ...
        ("allow-only-conn-window-open-tip", "Permite sa connessione petzi si sa ventana R-connect est aberta"),
        ...
        ("floating_window_tip", "Agiudat a mantènnere su servìtziu in s'isfundu de R-connect"),
        ...
        ("About R-connect", "Informatziones subra de R-connect"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Atualiza su cliente R-connect remotu a sa versione {} o prus noa!"),
