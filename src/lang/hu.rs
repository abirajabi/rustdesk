...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Előfordul, hogy bizonyos esetekben hiba léphet fel a Portable verzió használatakor. A megfelelő működés érdekében, telepítse a SISKOJAYA alkalmazást a számítógépére."),
        ("Click to upgrade", "Kattintson ide a frissítés telepítéséhez"),
        ("Configure", "Beállítás"),
        ("config_acc", "A számítógép távoli vezérléséhez a SISKOJAYAnek hozzáférési jogokat kell biztosítania."),
        ("config_screen", "Ahhoz, hogy távolról hozzáférhessen számítógépéhez, meg kell adnia a SISKOJAYAnek a \"Képernyőfelvétel\" jogosultságot."),
        ...
        ("android_input_permission_tip1", "Ahhoz, hogy egy távoli eszköz vezérelhesse Android készülékét, engedélyeznie kell a SISKOJAYA számára a \"Hozzáférhetőség\" szolgáltatás használatát."),
        ("android_input_permission_tip2", "A következő rendszerbeállítások oldalon a letöltött alkalmazások menüponton belül, kapcsolja be a [SISKOJAYA Input] szolgáltatást."),
        ...
        ("Language", "Nyelv"),
        ("Keep SISKOJAYA background service", "SISKOJAYA futtatása a háttérben"),
        ("Ignore Battery Optimizations", "Akkumulátorkímélő figyelmen kívül hagyása"),
        ("android_open_battery_optimizations_tip", "Ha le szeretné tiltani ezt a funkciót, lépjen a SISKOJAYA alkalmazás beállításaiba, keresse meg az [Akkumulátorkímélő] lehetőséget és válassza a nincs korlátozás lehetőséget."),
        ...
        ("Show SISKOJAYA", "A SISKOJAYA megjelenítése"),
        ...
        ("config_input", "Ahhoz, hogy a távoli asztalt a billentyűzettel vezérelhesse, a SISKOJAYAnek meg kell adnia a \"Bemenet figyelése\" jogosultságot."),
        ("config_microphone", "Ahhoz, hogy távolról beszélhessen, meg kell adnia a SISKOJAYAnek a \"Hangfelvétel\" jogosultságot."),
        ...
        ("still_click_uac_tip", "A távoli felhasználónak továbbra is az \"Igen\" gombra kell kattintania a SISKOJAYA UAC ablakában. Kattintson!"),
        ...
        ("verify_rustdesk_password_tip", "SISKOJAYA jelszó megerősítése"),
        ...
        ("scam_text1", "Ha olyan valakivel beszél telefonon, akit NEM ISMER, akiben NEM BÍZIK MEG, és aki arra kéri, hogy használja a SISKOJAYAet és indítsa el a szolgáltatást, ne folytassa, és azonnal tegye le a telefont."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Frissítse a SISKOJAYA Server Prot a(z) {} vagy újabb verzióra!"),
        ...
        ("selinux_tip", "A SELinux engedélyezve van az eszközén, ami azt okozhatja, hogy a SISKOJAYA nem fut megfelelően, mint ellenőrzött webhely."),
        ...
        ("powered_by_me", "Üzemeltető: SISKOJAYA"),
        ("outgoing_only_desk_tip", "Ez a SISKOJAYA testre szabott kimenete.\nMás eszközökhöz kapcsolódhat, de más eszközök nem kapcsolódhatnak az Ön eszközéhez."),
        ("preset_password_warning", "Ez egy testre szabott kimenet a SISKOJAYAből egy előre beállított jelszóval. Bárki, aki ismeri ezt a jelszót, teljes irányítást szerezhet a készülék felett. Ha nem kívánja ezt megtenni, azonnal távolítsa el ezt a szoftvert."),
        ...
        ("allow-only-conn-window-open-tip", "Csak akkor engedélyezze a kapcsolódást, ha a SISKOJAYA ablak nyitva van."),
        ...
        ("floating_window_tip", "Segít, ha a SISKOJAYA a háttérben fut."),
        ...
        ("About SISKOJAYA", "SISKOJAYA névjegye"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Frissítse a SISKOJAYA klienst {} vagy újabb verziójára a távoli oldalon!"),
