...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Conectando à rede do R-connect..."),
        ...
        ("install_tip", "Devido ao UAC, o R-connect não funciona corretamente como o lado remoto em alguns casos. Para evitar o UAC, por favor clique no botão abaixo para instalar o R-connect no sistema."),
        ("Click to upgrade", "Clique para fazer o upgrade"),
        ("Configure", "Configurar"),
        ("config_acc", "Para controlar seu computador remotamente, você precisa conceder ao R-connect permissões de \"Acessibilidade\"."),
        ("config_screen", "Para acessar seu computador remotamente, você precisa conceder ao R-connect permissões de \"Gravar a Tela\"/"),
        ...
        ("android_input_permission_tip1", "Para que um dispositivo remoto controle seu dispositivo Android via mouse ou toque, você precisa permitir que o R-connect use o serviço \"Acessibilidade\"."),
        ("android_input_permission_tip2", "Por favor vá para a próxima página de configuração do sistema, encontre e entre [Serviços Instalados], HABILITE o serviço [R-connect Input]."),
        ...
        ("Language", "Idioma"),
        ("Keep R-connect background service", "Manter o serviço do R-connect executando em segundo plano"),
        ...
        ("Show R-connect", "Exibir R-connect"),
        ...
        ("config_input", "Para controlar a área de trabalho remota com teclado, você precisa conceder a permissão \"Monitoramento de entrada\" do R-connect."),
        ("config_microphone", "Para falar remotamente, você precisa conceder a permissão \"Gravar áudio\" do R-connect."),
        ...
        ("still_click_uac_tip", "Ainda requer que o usuário remoto clique em OK na janela UAC da execução do R-connect."),
        ...
        ("verify_rustdesk_password_tip", "Verifique a senha do R-connect"),
        ...
        ("scam_text1", "Se você estiver ao telefone com alguém que NÃO conhece e em quem NÃO confia e essa pessoa pedir para você usar o R-connect e iniciar o serviço, NÃO faça isso !! e desligue imediatamente."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Atualize o R-connect Server Pro para a versão {} ou superior."),
        ...
        ("selinux_tip", "O SELinux está ativado em seu dispositivo, o que pode impedir que o R-connect funcione corretamente como dispositivo controlado."),
        ...
        ("powered_by_me", "Desenvolvido por R-connect"),
        ...
        ("allow-only-conn-window-open-tip", "Permitir conexões apenas quando a janela do R-connect estiver aberta"),
        ...
        ("floating_window_tip", "Ajuda a manter o serviço R-connect em segundo plano"),
        ...
        ("About R-connect", "Sobre R-connect"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Atualize o cliente R-connect para a versão {} ou superior no lado remoto."),
