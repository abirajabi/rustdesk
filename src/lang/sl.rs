...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Vzpostavljanje povezave z omrežjem SISKOJAYA..."),
        ...
        ("install_tip", "Zaradi nadzora uporabniškega računa, SISKOJAYA v nekaterih primerih na oddaljeni strani ne deluje pravilno. Temu se lahko izognete z namestitvijo."),
        ("Click to upgrade", "Klikni za nadgradnjo"),
        ("Configure", "Nastavi"),
        ("config_acc", "Za oddaljeni nadzor namizja morate SISKOJAYAu dodeliti pravico za dostopnost"),
        ("config_screen", "Za oddaljeni dostop do namizja morate SISKOJAYAu dodeliti pravico snemanje zaslona"),
        ...
        ("android_input_permission_tip1", "Za oddaljeni nadzor vaše naprave Android, je potrebno SISKOJAYAu dodeliti pravico za dostopnost."),
        ("android_input_permission_tip2", "Pojdite v sistemske nastavitve, poiščite »Nameščene storitve« in vklopite storitev »SISKOJAYA Input«."),
        ...
        ("Language", "Jezik"),
        ("Keep SISKOJAYA background service", "Ohrani SISKOJAYAovo storitev v ozadju"),
        ("Ignore Battery Optimizations", "Prezri optimizacije baterije"),
        ("android_open_battery_optimizations_tip", "Če želite izklopiti to možnost, pojdite v nastavitve aplikacije SISKOJAYA, poiščite »Baterija« in izklopite »Neomejeno«"),
        ...
        ("config_input", "SISKOJAYA potrebuje pravico »Nadzor vnosa« za nadzor oddaljenega namizja s tipkovnico."),
        ("config_microphone", "SISKOJAYA potrebuje pravico »Snemanje zvoka« za zajemanje zvoka."),
        ...
        ("verify_rustdesk_password_tip", "Preveri geslo za SISKOJAYA"),
        ...
        ("scam_text1", "V primeru, da vas je nekdo, ki ga ne poznate in mu zaupate prosil, da uporabite SISKOJAYA, prekinite klic in program zaprite."),
        ("scam_text2", "SISKOJAYA omogoča popoln nadzor nad vašim računalnikom in telefonom, in se lahko uporabi za krajo vašega denarja ali pa zasebnih podatkov."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Prosimo, nadgradite SISKOJAYA Server Pro na različico {} ali novejšo."),
        ...
        ("powered_by_me", "Uporablja tehnologijo SISKOJAYA"),
        ...
        ("allow-only-conn-window-open-tip", "Dovoli povezavo samo če je okno SISKOJAYAa odprto"),
        ...
        ("floating_window_tip", "Pomaga pri SISKOJAYA storitvi v ozadju"),
        ...
        ("Accessible devices", ""),
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Prosimo, nadgradite SISKOJAYA odjemalec na različico {} ali novejšo na oddaljeni strani."),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
